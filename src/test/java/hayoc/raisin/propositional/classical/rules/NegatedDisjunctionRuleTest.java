...
public class NegatedDisjunctionRuleTest {
    ...
    public void testNegatedDisjunctionRule() {
        PropositionalClassicalRule rule = new NegatedDisjunctionRule(new PropositionalClassicalRuleUtilities());
        assertTrue(rule.applicable(new Node("~((A > B) | (B & C))")));
        ...
        assertFalse(rule.applicable(new Node("~((A > B) & (B & C))")));
        assertFalse(rule.applicable(new Node("((A > B) | (B & C))")));
    }
}
