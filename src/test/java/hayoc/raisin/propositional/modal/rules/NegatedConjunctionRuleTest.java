...
public class NegatedConjunctionRuleTest {
    ...
    public void testNegatedConjunctionRule() {
        Rule rule = new NegatedConjunctionRule(new PropositionalModalRuleUtilities(modalUtilities), modalUtilities);
        ...
        assertFalse(rule.applicable(new PropositionalModalNode("(A & B)")));
    }
}
